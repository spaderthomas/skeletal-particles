...
#include <stdint.h>
        ...
        #define CIMGUI_EXPORT
    #else
        #define CIMGUI_EXPORT __declspec(dllexport)
    #endif
#else
    #ifdef __GNUC__
        #define CIMGUI_EXPORT  __attribute__((__visibility__("default")))
    #else
        #define CIMGUI_EXPORT
    #endif
#endif
...
#define CIMGUI_API EXTERN CIMGUI_EXPORT
#define CONST const
